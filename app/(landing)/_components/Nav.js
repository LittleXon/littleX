  ...
  return (
    ...
    >
      <div className="flex items-center justify-between p-4 lg:px-8 mx-auto max-w-screen-xl">
        ...
        <a href="https://dexscreener.com/solana/bchkddmow5vsjsvbd5sayrzkq5umpptfxxjwhxmvu1js" target="_blank" className="transition duration-200 font-stopbuck text-lg sm:text-2xl rounded-xl px-3.5 py-2.5 font-medium text-white shadow-2xl bg-red-600 hover:bg-white hover:text-red-600 hover:outline-red-600 outline outline-2 outline-offset-0" >
          Buy $LittleX
        </a>
        </div>
      </div>
